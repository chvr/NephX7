...
s0_outline_color = #00ff009f
s0_fill_color = #00ff004f
...
[core]
s0_active_plugins = core;composite;opengl;imgjpeg;compiztoolbox;decor;resize;imgpng;wall;regex;grid;mousepoll;snap;place;gnomecompat;vpswitch;animation;session;move;fade;expo;workarounds;ezoom;switcher;scale;
...
s0_minimize_window_key = <Super>n
...
s0_toggle_window_maximized_key = <Super>m
