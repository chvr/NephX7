...
# Usage: ./feeds-log-parser.sh feeds-solution.log --output output.txt --force --verbose
#   or simply: ./feeds-log-parser.sh -f -v
#
# For help: ./feeds-log-parser.sh --help
#
#
# Version History
#
...
def setup_command_args():
    ...
    if unknown_args:
        ...
        print('Try \'./%s --help\' for more information.' % os.path.basename(__file__))
        sys.exit()
